...
function SvgComponent(
    ...
    return (
        <Svg width={46} height={46} viewBox="0 0 46 46" ref={svgRef} {...props}>
            <Defs>
                <Rect
                    id="prefix__b"
                    x={0}
...
const Btn_google_light_normal_ios = React.memo(ForwardRef);
export default Btn_google_light_normal_ios;
